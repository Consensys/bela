...
public class Constants {
    ...
    public static final String OVERRIDE_STORAGE_PATH = "OVERRIDE_STORAGE_PATH";
    ...
    public static final Character KEY_DELETE = '!';
    ...
    public static final Character KEY_BLOCKCHAIN_SIZES = 'b';
