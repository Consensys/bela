...
public class AccountChangeNode extends AbstractBonsaiNode {
  private final AccountValue prior;
  private final AccountValue updated;
  private final Address address;

  public AccountChangeNode(final Address address, final AccountValue prior,
      final AccountValue updated) {
  ...
  public Component createComponent() {
    ...
    if (prior.getNonce() != updated.getNonce()) {
      ...
      panel.addComponent(LabelWithTextBox
          .labelWithTextBox("Prior:", String.valueOf(prior.getNonce()))
          .createComponent());
      panel.addComponent(LabelWithTextBox
          .labelWithTextBox("Updated:", String.valueOf(updated.getNonce()))
          .createComponent());
    ...
    if (!prior.getBalance().equals(updated.getBalance())) {
      ...
      panel.addComponent(LabelWithTextBox
          .labelWithTextBox("Prior:", String.valueOf(prior.getBalance()))
          .createComponent());
      panel.addComponent(LabelWithTextBox
          .labelWithTextBox("Updated:", String.valueOf(updated.getBalance()))
          .createComponent());
      panel.addComponent(new EmptySpace());
    }
    if (!prior.getCodeHash().equals(updated.getCodeHash())) {
      ...
      panel.addComponent(LabelWithTextBox
          .labelWithTextBox("Prior:", String.valueOf(prior.getCodeHash()))
          .createComponent());
      panel.addComponent(LabelWithTextBox
          .labelWithTextBox("Updated:", String.valueOf(updated.getCodeHash()))
          .createComponent());
      panel.addComponent(new EmptySpace());
    }
    if (!prior.getStorageRoot().equals(updated.getStorageRoot())) {
      ...
      panel.addComponent(LabelWithTextBox
          .labelWithTextBox("Prior:", String.valueOf(prior.getStorageRoot()))
          .createComponent());
      panel.addComponent(LabelWithTextBox
          .labelWithTextBox("Updated:", String.valueOf(updated.getStorageRoot()))
          .createComponent());
    }
  ...
  public void log() {
    ...
    log.info("Balance: {} -> {}", prior != null ? prior.getBalance() : "null",
        updated.getBalance());
    log.info("Code: {} -> {}", prior != null ? prior.getCodeHash().toHexString() : "null",
        updated.getCodeHash());
    log.info("Storage: {} -> {}", prior != null ? prior.getStorageRoot().toHexString() : "null",
